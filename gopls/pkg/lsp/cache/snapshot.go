...
import (
	...
	"golang.org/x/tools/gopls/pkg/filecache"
	"golang.org/x/tools/gopls/pkg/lsp/cache/metadata"
	"golang.org/x/tools/gopls/pkg/lsp/cache/methodsets"
	"golang.org/x/tools/gopls/pkg/lsp/cache/typerefs"
	"golang.org/x/tools/gopls/pkg/lsp/cache/xrefs"
	"golang.org/x/tools/gopls/pkg/lsp/command"
	"golang.org/x/tools/gopls/pkg/lsp/protocol"
	"golang.org/x/tools/gopls/pkg/settings"
	"golang.org/x/tools/gopls/pkg/util/bug"
	"golang.org/x/tools/gopls/pkg/util/constraints"
	"golang.org/x/tools/gopls/pkg/util/immutable"
	"golang.org/x/tools/gopls/pkg/util/maps"
	"golang.org/x/tools/gopls/pkg/util/pathutil"
	"golang.org/x/tools/gopls/pkg/util/persistent"
