...
import (
	...
	"golang.org/x/tools/gopls/pkg/lsp/analysis/deprecated"
	"golang.org/x/tools/gopls/pkg/lsp/analysis/embeddirective"
	"golang.org/x/tools/gopls/pkg/lsp/analysis/fillreturns"
	"golang.org/x/tools/gopls/pkg/lsp/analysis/fillstruct"
	"golang.org/x/tools/gopls/pkg/lsp/analysis/infertypeargs"
	"golang.org/x/tools/gopls/pkg/lsp/analysis/nonewvars"
	"golang.org/x/tools/gopls/pkg/lsp/analysis/noresultvalues"
	"golang.org/x/tools/gopls/pkg/lsp/analysis/simplifycompositelit"
	"golang.org/x/tools/gopls/pkg/lsp/analysis/simplifyrange"
	"golang.org/x/tools/gopls/pkg/lsp/analysis/simplifyslice"
	...
	"golang.org/x/tools/gopls/pkg/lsp/analysis/unusedvariable"
	"golang.org/x/tools/gopls/pkg/lsp/analysis/useany"
